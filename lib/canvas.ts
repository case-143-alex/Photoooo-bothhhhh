...
export function captureFromVideo(
  ...
  // JPEG instead of PNG: 5-10x smaller file size for the same photo, which
  // matters a lot when transferring over Socket.IO to phones on slower or
  // more restrictive networks. Quality 0.85 is visually lossless for photos.
